...
\usepackage{graphicx}
\graphicspath{{./images/}{./images/chapter1/}{./images/chapter2/}{./images/chapter3/}{./images/chapter4/}} % пути к каталогам с изображениями
...
\captionsetup[algorithm]{name = Листинг, labelsep=endash}

% Листинги с исходным кодом
\usepackage{listings}
\lstloadlanguages{[Sharp]C}
\lstset{language=[Sharp]C, morekeywords={var}}
